...
-- theme.highlight_fg_bg('Visual', theme.base16.base04, theme.base16.base01)
...
theme.highlight_bg('Error', theme.base16.base03)
...
theme.highlight_bg('WarningMsg', theme.base16.base00)
